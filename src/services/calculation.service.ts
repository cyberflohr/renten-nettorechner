...
export class CalculationService {
  ...
  const PV_CHILDREN_BEITRAGSSATZ = 0.028; // Pflegeversicherung (mit Kindern)
    ...
    const BESTEUERUNGSANTEIL_RENTE_TABLE = [
      ...
      { year: 2023, percentage: 0.825 },
      { year: 2024, percentage: 0.83 },
      { year: 2025, percentage: 0.835 },
      { year: 2026, percentage: 0.84 },
      { year: 2027, percentage: 0.845 },
      { year: 2028, percentage: 0.85 },
      { year: 2029, percentage: 0.855 },
      { year: 2030, percentage: 0.86 },
      { year: 2031, percentage: 0.865 },
      { year: 2032, percentage: 0.87 },
      { year: 2033, percentage: 0.875 },
      { year: 2034, percentage: 0.88 },
      { year: 2035, percentage: 0.885 },
      { year: 2036, percentage: 0.89 },
      { year: 2037, percentage: 0.895 },
      { year: 2038, percentage: 0.90 },
      { year: 2039, percentage: 0.905 },
      { year: 2040, percentage: 0.91 },
      { year: 2041, percentage: 0.915 },
      { year: 2042, percentage: 0.92 },
      { year: 2043, percentage: 0.925 },
      { year: 2044, percentage: 0.93 },
      { year: 2045, percentage: 0.935 },
      { year: 2046, percentage: 0.94 },
      { year: 2047, percentage: 0.945 },
      { year: 2048, percentage: 0.95 },
      { year: 2049, percentage: 0.955 },
      { year: 2050, percentage: 0.96 },
      { year: 2051, percentage: 0.965 },
      { year: 2052, percentage: 0.97 },
      { year: 2053, percentage: 0.975 },
      { year: 2054, percentage: 0.98 },
      { year: 2055, percentage: 0.985 },
      { year: 2056, percentage: 0.99 },
      { year: 2057, percentage: 0.995 },
      { year: 2058, percentage: 1.00 },
    ];
